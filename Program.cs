...
namespace isci.modellaustausch
{
    ...
    class Program
    {
        ...
        {
            Gesamtbeschreibung
            Abbild einer Anwendung
            management zugriff?
            infos zu zykluszeiten
            ausführungsmodelle
            schnittstellen?
            speicherplatza
            architektur
            netzwerkinfos
            push-fähigkeit für informationen?
            systeminformationen
            sicherung? << konfigurationsdateien, logs, modulidentifikationen mit versionen, umgebungsvariablen
            kann ich docker sichern?


            /* idee ist die brücke zu den entwicklungstools zu schlagen: iiot, überwachung, informationen für unsere entwicklungsumgebungen, aas-generator */
            




            SimpleHttp.Route.Add("A")
